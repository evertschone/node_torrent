...
declare module 'matroska' {
    export class Decoder {
        constructor(options?: any);
        parse(data: Buffer, callback: (err: Error | null, doc: any[]) => void): void;
        parseEbmlIDs(url: string, ids: any[], callback: (err: Error | null, doc: any) => void): void;
    }
