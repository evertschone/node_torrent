...
INSERT INTO "new_TorrentContent" ("availability", "hardlinkPath", "id", "is_seed", "name", "piece_range", "piece_size", "priority", "progress", "size", "torrentId") SELECT "availability", "hardlinkPath", "id", "is_seed", "name", "piece_range", "piece_size", "priority", "progress", "size", "torrentId" FROM "TorrentContent";
