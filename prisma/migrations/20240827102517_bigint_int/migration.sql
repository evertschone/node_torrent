/*
  ...
  - You are about to alter the column `size` on the `Result` table. The data in that column could be lost. The data in that column will be cast from `BigInt` to `Int`.
